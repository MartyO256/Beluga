...
let dep_name_of_nb =
  function
  | `blank location -> (Depend.implicit, Name.make_blank location)
  | `name name -> (Depend.explicit, name)
...
let clf_ctyp_decl_bare : type a. a name_parser -> (a -> Depend.t * Name.t) -> LF.ctyp_decl t =
